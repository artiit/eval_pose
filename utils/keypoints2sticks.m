...
if joint_n == 14 % LSP and PARSE
  ...
  %sticks(:,1:2,:)   = [keypoints(:, 1, :), keypoints(:, 2, :)];                                % Head
  sticks(:,1:2,:)   = [keypoints(:, 7, :), keypoints(:, 5, :)];                                % Left Upper Arm
  sticks(:,3:4,:)   = [keypoints(:, 5, :), keypoints(:, 3, :)];                                % Left Lower Arm
  sticks(:,5:6,:)  = [keypoints(:, 6, :), keypoints(:, 4, :)];                                % Right Upper Arm
  sticks(:,7:8,:) = [keypoints(:, 4, :), keypoints(:, 2, :)];                                % Right Lower Arm
end
end